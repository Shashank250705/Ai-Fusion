...
class ImageGenScreen extends StatefulWidget {
  const ImageGenScreen({super.key, this.page = 'login', required this.onItemRemoved});
  final String page;
                ...
                children: [
                  ...
                  Center(
                    child: ElevatedButton(
                      onPressed: () => _launchURL(Uri.parse('https://openai.com/index/dall-e-2/'), true),
