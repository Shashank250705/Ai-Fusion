...
class _DesignToolsState extends State<DesignTools> {
  ...
  void _onContainerTap(String toolName) {
    if (toolName == 'Runway ML') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => DesignScreen(onItemRemoved: (String ) {  },)),
      );
    }
      ...
      body: ListView(
        ...
        children: [
          Padding(
            ...
            child: Column(
              children: [
                buildTaggedLottieContainer('Runway ML', [Colors.blue, Colors.lightBlueAccent]),
                SizedBox(height: 10.0),
                buildTaggedLottieContainer('Artbreeder', [Colors.purple, Colors.deepPurpleAccent]),
                SizedBox(height: 10.0),
                buildTaggedLottieContainer('DeepArt.io', [Colors.indigo, Colors.indigoAccent]),
                SizedBox(height: 10.0),
                buildTaggedLottieContainer('DeepDream Generator', [Colors.orange, Colors.deepOrangeAccent]),
              ],
            ),
          ),
        ],
